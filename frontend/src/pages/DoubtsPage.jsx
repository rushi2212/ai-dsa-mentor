      ...
      <section className="bg-gradient-to-b from-blue-900/30 to-transparent border-b border-slate-800/50 py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center">
            <p className="text-amber-400 font-semibold text-sm mb-2 uppercase tracking-wide">
              💬 Ask Doubts
            </p>
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Chat with our AI mentor to clarify concepts and resolve confusion
            </p>
          </div>
        </div>
      </section>
